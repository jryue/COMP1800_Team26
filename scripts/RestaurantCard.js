    ...
    db.collection("Restaurants")
        ...
        .then(function(snap) {
            snap.forEach(function(doc) {
                ...
                var d1 = $('#card-container').append('<div class="card" style="width: 18rem;">');
                var i = d1.append('<img class="card-img-top" src="/images/orange.png" alt="Card image cap">');
                ...
                d2.append('<p class="card-text">' + masks + '</p>');
                d2.append("<a href='#' class='btn btn-primary'>Go</a>");
